package org.jsanz.front.view.monumentfinder.view;
...
@Component
public class MonumentFinderView extends JPanel{
	...
	public static final String FRM_BTN_MONUMENT_SEARCH = "frm.btn.monumentfinder.search";

	private JFormattedTextField seed;
	private static final String FRM_LBL_MONUMENT_SEED = "frm.lbl.monumentfinder.seed";

	private JFormattedTextField centerX, centerY;
	private static final String FRM_LBL_MONUMENT_CENTER_X = "frm.lbl.monumentfinder.center.x";
	private static final String FRM_LBL_MONUMENT_CENTER_Y = "frm.lbl.monumentfinder.center.y";

	private JFormattedTextField radio;
	private static final String FRM_LBL_MONUMENT_RADIO = "frm.lbl.monumentfinder.radio";
	...
	private JPanel fila1() {
		// label seed
		JLabel lblSeed = new JLabel(messageSource.getMessage(FRM_LBL_MONUMENT_SEED,
				new Object[] { FRM_LBL_MONUMENT_SEED }, Locale.getDefault()));
		...
		// boton buscar
		btnBuscar = new JButton(messageSource.getMessage(FRM_BTN_MONUMENT_SEARCH,
				new Object[] { FRM_BTN_MONUMENT_SEARCH }, Locale.getDefault()));
		btnBuscar.setActionCommand(FRM_BTN_MONUMENT_SEARCH);
		btnBuscar.addActionListener(monumentfinderController);
	...
	private JPanel fila2() {
		...
		// label center
		JLabel lblSCenterX = new JLabel(messageSource.getMessage(FRM_LBL_MONUMENT_CENTER_X,
				new Object[] { FRM_LBL_MONUMENT_CENTER_X }, Locale.getDefault()));
		JLabel lblSCenterY = new JLabel(messageSource.getMessage(FRM_LBL_MONUMENT_CENTER_Y,
				new Object[] { FRM_LBL_MONUMENT_CENTER_Y }, Locale.getDefault()));
	...
	private JPanel fila3() {
		// label center
		JLabel lblRadio = new JLabel(messageSource.getMessage(FRM_LBL_MONUMENT_RADIO,
				new Object[] { FRM_LBL_MONUMENT_RADIO }, Locale.getDefault()));
