package org.jsanz.front.view.slimefinder.view;
...
@Component
public class SlimefinderView extends JPanel {
	...
	public static final String FRM_BTN_SLIMEFINDER_SEARCH = "frm.btn.slimefinder.search";

	private JFormattedTextField seed;
	private static final String FRM_LBL_SLIMEFINDER_SEED = "frm.lbl.slimefinder.seed";

	private JFormattedTextField centerX, centerY;
	private static final String FRM_LBL_SLIMEFINDER_CENTER_X = "frm.lbl.slimefinder.center.x";
	private static final String FRM_LBL_SLIMEFINDER_CENTER_Y = "frm.lbl.slimefinder.center.y";

	private JFormattedTextField radio;
	private static final String FRM_LBL_SLIMEFINDER_RADIO = "frm.lbl.slimefinder.radio";
	...
	private JPanel fila1() {
		// label seed
		JLabel lblSeed = new JLabel(messageSource.getMessage(FRM_LBL_SLIMEFINDER_SEED,
				new Object[] { FRM_LBL_SLIMEFINDER_SEED }, Locale.getDefault()));
		...
		// boton buscar
		btnBuscar = new JButton(messageSource.getMessage(FRM_BTN_SLIMEFINDER_SEARCH,
				new Object[] { FRM_BTN_SLIMEFINDER_SEARCH }, Locale.getDefault()));
		btnBuscar.setActionCommand(FRM_BTN_SLIMEFINDER_SEARCH);
		btnBuscar.addActionListener(slimefinderController);
	...
	private JPanel fila2() {
		...
		// label center
		JLabel lblSCenterX = new JLabel(messageSource.getMessage(FRM_LBL_SLIMEFINDER_CENTER_X,
				new Object[] { FRM_LBL_SLIMEFINDER_CENTER_X }, Locale.getDefault()));
		JLabel lblSCenterY = new JLabel(messageSource.getMessage(FRM_LBL_SLIMEFINDER_CENTER_Y,
				new Object[] { FRM_LBL_SLIMEFINDER_CENTER_Y }, Locale.getDefault()));
	...
	private JPanel fila3() {
		// label center
		JLabel lblRadio = new JLabel(messageSource.getMessage(FRM_LBL_SLIMEFINDER_RADIO,
				new Object[] { FRM_LBL_SLIMEFINDER_RADIO }, Locale.getDefault()));
