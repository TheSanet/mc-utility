...
@Component
@Qualifier("monumentFinderController")
public class MonumentFinderController {
	
	@Autowired
	private JobLauncher jobLuncher;
	
	@Autowired
	@Qualifier(IJobs.MONUMENT_FINDER)
	private Job job;

	@SuppressWarnings("rawtypes")
	public void search(Long seed, Integer x, Integer z, Integer radio, Integer occurrences) {
		//Lanza el job
		...
		map.put("occurrences", new JobParameter(occurrences,occurrences.getClass()));
		try {
